...
public static class BlockHelper
{
    ...
    public static Vector2[] FaceUVs(Direction direction, BlockType blockType)
	{
		...
		UVs[0] = new Vector2(BlockDataManager.tilesSizeX * tilePos.x + BlockDataManager.tilesSizeX - BlockDataManager.TextureOffset, 
			BlockDataManager.tilesSizeY * tilePos.y + BlockDataManager.TextureOffset);

		UVs[1] = new Vector2(BlockDataManager.tilesSizeX * tilePos.x + BlockDataManager.tilesSizeX - BlockDataManager.TextureOffset,
			BlockDataManager.tilesSizeY * tilePos.y + BlockDataManager.tilesSizeY - BlockDataManager.TextureOffset);

		UVs[2] = new Vector2(BlockDataManager.tilesSizeX * tilePos.x + BlockDataManager.TextureOffset,
			BlockDataManager.tilesSizeY * tilePos.y + BlockDataManager.tilesSizeY - BlockDataManager.TextureOffset);

		UVs[3] = new Vector2(BlockDataManager.tilesSizeX * tilePos.x + BlockDataManager.TextureOffset,
			BlockDataManager.tilesSizeY * tilePos.y + BlockDataManager.TextureOffset);
